class ReservationsController < ApplicationController
  ...
  def create
    ...
    if @reservation
      ...
      values = {
        business: 'support-facilitator@pethome.co',
        cmd: '_xclick',
        upload: 1,
        notify_url: 'http://08b20acb.ngrok.io/notify',
        amount: @reservation.total,
        item_name: @reservation.room.listing_name,
        item_number: @reservation.id,
        quantity: '1',
        return: 'http://08b20acb.ngrok.io/your_trips'
      }

      redirect_to "https://www.sandbox.paypal.com/cgi-bin/webscr?" + values.to_query
    else
      redirect_to @reservation.room, alert: "Opps, something went wrong..."
    end
  end
